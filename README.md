# 🤖 Advanced AI Data Analyst + ML Tool
...
* **Interactive Visualizations:** High-quality Histograms, Boxplots, and Correlation Heatmaps using Seaborn and Matplotlib.
* **Auto-ML:** Train Random Forest models for both Classification and Regression tasks.
* **Feature Importance:** Visualizes which variables impact your target variable the most.
* **Downloadable Reports:** Generate and download a summary report of your dataset.
